...
public class RNMapsAMapViewManagerDelegate<T extends View, U extends BaseViewManager<T, ? extends LayoutShadowNode> & RNMapsAMapViewManagerInterface<T>> extends BaseViewManagerDelegate<T, U> {
  public RNMapsAMapViewManagerDelegate(U viewManager) {
    super(viewManager);
  }
  @Override
